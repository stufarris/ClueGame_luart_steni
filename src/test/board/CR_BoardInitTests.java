...
public class CR_BoardInitTests {
	...
	public void testBadColumns() throws BadConfigFormatException,
		...
		Board b = new Board("data/board/ClueLayoutBadColumns.csv", "data/board/ClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException,
		...
		Board b = new Board("data/board/ClueLayoutBadRoom.csv", "data/board/ClueLegend.txt");
		b.loadRoomConfig();
		b.loadBoardConfig();
	}
	...
	public void testBadRoomFormat() throws BadConfigFormatException,
			FileNotFoundException {
		// overloaded Board ctor takes config file name
		Board b = new Board("data/board/ClueLayout.csv", "data/board/ClueLegendBadFormat.txt");
		b.loadRoomConfig();
		b.loadBoardConfig();
	}
}